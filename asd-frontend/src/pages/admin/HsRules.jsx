...
// import arab from '../../assets/icon/arab.png'
...
//     id: 2,
//     hsCode: "6109.30",
//     name: "T-shirt singlets and other vests, of cotton",
//     category: "Electronics",
//     importDuty: "12%",
//     exportRestriction: "Certificate required",
//   },
//   {
//     id: 3,
//     hsCode: "6109.30",
...
//     docs: "Certificate of Origin, Invoice, Packing list",
//     restriction: "None",
//     updated: "May 20, 2024",
//   },
//   {
...
//     docs: "Invoice, Packing List, Import License",
//     restriction: "Import license required",
//     updated: "May 18, 2024",
//   },
//   {
//     img: germany, 
...
//     docs: "Invoice, Packing List, Import License",
//     restriction: "Prohibited under national policy",
//     updated: "May 10, 2024",
//   },
// ];
...
//               Product classification rules and import/export guidelines
//             </p>
//           </div>
//           <button
//             onClick={onAddClick}
...
//         <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5">
//           <div className="flex items-center border-2 border-gray-200 rounded-xl px-3 py-2.5 gap-2 focus-within:border-teal-500 focus-within:ring-2 focus-within:ring-teal-500/10 transition-all mb-1">
//             <FaMagnifyingGlass className="text-gray-400 text-sm sm:text-lg flex-shrink-0" />
//             <input
//               className="flex-1 text-sm outline-none bg-transparent sm:placeholder:text-base py-2"
//               placeholder="Search by HS Code or Commodity Name"
//               value={search}
//               onChange={(e) => handleSearch(e.target.value)}
//             />
//           </div>
//           {searchError && (
//             <p className="text-xs text-red-500 mb-2 px-1">{searchError}</p>
//           )}
...
//               <thead>
//                 <tr className="bg-teal-50">
//                   <th className="text-left text-xs sm:text-base font-semibold text-teal-600 px-3 py-3 rounded-l-xl">
//                     HS CODE
//                   </th>
//                   <th className="text-left text-xs sm:text-base font-semibold text-teal-600 px-3 py-3">
//                     COMMODITY NAME
//                   </th>
//                   <th className="text-left text-xs sm:text-base font-semibold text-teal-600 px-3 py-3">
//                     CATEGORY
...
//                     IMPORT DUTY
//                   </th>
//                   <th className=" text-xs text-center sm:text-base font-semibold text-teal-600 px-3 py-3">
//                     EXPORT RESTRICTIONS
//                   </th>
//                   <th className="text-center text-xs sm:text-base font-semibold text-teal-600 px-3 py-3 rounded-r-xl">
//                     ACTIONS
//                   </th>
//                 </tr>
//               </thead>
...
//                       <td className="text-xs sm:text-base xl:text-lg  px-3 py-3 font-medium">
//                         {row.hsCode}
//                       </td>
//                       <td className="text-xs sm:text-base  xl:text-lg font-medium text-gray-600 px-3 py-3 max-w-[180px]">
//                         {row.productName}
//                       </td>
//                       <td className="px-3 py-3">
//                         <span className="text-xs sm:text-base  xl:text-lg bg-purple-100  text-purple-600 px-2.5 py-1 rounded-lg font-medium">
//                           {row.category?.name || "-"}
//                         </span>
//                       </td>
//                       <td className="text-sm sm:text-base  xl:text-lg text-black  font-semibold px-3 py-3">
//                         {row.tradeInfo?.importDuty + "%" || "-"}
//                       </td>
//                       <td className="px-3 py-3 text-center">
//                         <span
//                           className={`text-xs sm:text-base  xl:text-lg whitespace-nowrap px-2.5 py-1  rounded-lg font-medium ${
//                             row.exportRestriction === "None"
//                               ? "bg-teal-100 text-teal-600"
//                               : "bg-orange-100 text-orange-500"
//                           }`}
//                         >
//                           {row.tradeInfo?.restrictedItem
//                             ? "Restricted"
//                             : "None"}
//                         </span>
//                       </td>
...
//                           className="text-teal-500 font-medium text-sm sm:text-base  xl:text-lg"
//                         >
//                           Edit
//                         </button>
//                       </td>
...
//                 disabled={page === 1}
//                 className="px-4 py-2 text-sm  sm:text-base   border border-gray-200 rounded-xl  hover:bg-gray-50 disabled:opacity-40 font-medium transition-colors"
//               >
//                 Preview
//               </button>
//               {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
...
//               Add Hs Code
//             </h1>
//             <p className="text-xs sm:text-base xl:text-lg text-[#575757] mt-0.5">
//               Add hs code.
//             </p>
//           </div>
//           <div className="flex items-center sm:flex-row flex-col gap-2">
...
//             {/* SECTION 1 - Basic HS Code Details */}
//             <div className="bg-white rounded-2xl border-2 border-teal-400 p-4 sm:p-5 shadow-sm">
//               <h2 className="text-sm  sm:text-lg xl:text-xl font-semibold   mb-4">
//                 Basic HS Code Details
//               </h2>
//               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium  mb-1.5">
//                     HS Code Number
//                   </label>
//                   <input
//                     className="w-full border placeholder:text-[#717171] border-gray-200 rounded-xl placeholder:text-base px-3 py-2.5 text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 transition-all"
//                     placeholder="878686768768"
//                     value={form.hsCodeNumber || ""}
//                     onChange={(e) => set("hsCodeNumber", e.target.value)}
//                   />
//                   <p className="text-xs text-[#717171] mt-1">
//                     Enter 8 or 10 digit HS code number
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium   mb-1.5">
...
//                   </label>
//                   <textarea
//                     className="w-full border border-gray-200 rounded-xl  placeholder:text-[#717171] placeholder:text-base px-3 py-2.5 text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 resize-none transition-all"
//                     rows={4}
//                     placeholder="Enter Product description users materials , etc"
//                     value={form.productDesc}
//                     onChange={(e) => set("productDesc", e.target.value)}
//                   />
//                   <p className="text-xs text-[#717171] mt-1">
//                     Detailed description helps in accurate classification
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium  mb-1.5">
...
//                   </label>
//                   <input
//                     className="w-full border border-gray-200 rounded-xl placeholder:text-[#717171] placeholder:text-base px-3 py-2.5 text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 transition-all"
//                     placeholder="Enter Product Name"
//                     value={form.productName}
//                     onChange={(e) => set("productName", e.target.value)}
//                   />
//                   <p className="text-xs  text-[#717171] mt-1">
//                     Use common name for easier identification
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium   mb-1.5">
...
//                   </label>
//                   <div className="border border-gray-200 rounded-xl placeholder:text-[#717171] placeholder:text-base px-3 py-2.5 flex flex-wrap gap-1.5 items-center focus-within:border-teal-500 transition-all">
//                     {form.countries?.map((c) => (
//                       <span
//                         key={c}
//                         className="flex items-center gap-1 placeholder:text-base bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded-lg"
//                       >
//                         {c}
//                         <button
//                           onClick={() =>
...
//                       </span>
//                     ))}
//                     <span className="text-xs text-teal-500 cursor-pointer">
//                       +12
//                     </span>
//                   </div>
//                   <p className="text-xs  text-[#717171] mt-1">
//                     Select countries where this HS code is applicable
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium   mb-1.5">
...
//                     {categories.map((c) => (
//                       <option key={c._id} value={c._id} className="placeholder:text-base">
//                         {" "}
//                         {/* ✅ ONLY _id */}
//                         {c.name}
//                       </option>
...
//                   </select>
//                   <p className="text-xs  text-[#717171] mt-1">
//                     Search and select product category
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium  mb-1.5">
...
//                   </div>
//                   <p className="text-xs  text-[#717171] mt-1">
//                     Inactive codes won't be visible
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//             {/* SECTION 2 - Trade Information */}
//             <div className="bg-white rounded-2xl border border-gray-100 p-4 sm:p-5 shadow-sm">
//               <h2 className="text-sm  sm:text-lg xl:text-xl font-semibold text-gray-800 mb-4">
//                 Trade Information
//               </h2>
//               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                 <div>
...
//                     onChange={(e) => set("importDuty", e.target.value)}
//                   />
//                   <p className="text-xs text-[#717171] mt-1">
//                     Enter import duty percentage
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium  mb-1.5">
...
//                   <input
//                     className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 transition-all"
//                     value={form.exportDuty}
//                     onChange={(e) => set("exportDuty", e.target.value)}
//                   />
//                   <p className="text-xs text-[#717171] mt-1">
//                     Enter export duty percentage
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium  mb-1.5">
...
//                 <div className="flex flex-col sm:flex-row gap-4">
//                   <div className="flex-1">
//                     <label className="block text-xs sm:text-base  font-medium  mb-1.5">
//                       Restricted Item
//                     </label>
//                     <div className="flex items-center gap-2 mt-2">
//                       <Toggle
//                         checked={form.restrictedItem}
//                         onChange={(v) => set("restrictedItem", v)}
//                       />
//                       <span className="text-sm text-gray-600">
//                         {form.restrictedItem ? "yes" : "no"}
//                       </span>
//                     </div>
//                     <p className="text-xs text-[#717171] mt-1">
//                       disable if item is not restricted
//                     </p>
//                   </div>
//                   <div className="flex-1">
//                     <label className="block text-xs sm:text-base  font-medium  mb-1.5">
...
//                       />
//                       <span className="text-sm text-gray-600">
//                         {form.licenseRequired ? "yes" : "no"}
//                       </span>
//                     </div>
//                     <p className="text-xs text-[#717171] mt-1">
//                       disable if license is not restricted
//                     </p>
//                   </div>
//                 </div>
//                 <div>
...
//                   <input
//                     className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 transition-all"
//                     value={form.customsClearanceTime}
//                     onChange={(e) =>
//                       set("customsClearanceTime", e.target.value)
//                     }
//                   />
//                   <p className="text-xs text-[#717171] mt-1">
//                     Average time for customs clearance
//                   </p>
//                 </div>
//                 <div>
//                   <label className="block text-xs sm:text-base xl:text-lg font-medium  mb-1.5">
...
//                   <select
//                     className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-teal-500 bg-white transition-all"
//                     value={form.tradeVolumeLevel}
//                     onChange={(e) => set("tradeVolumeLevel", e.target.value)}
//                   >
//                     <option>High</option>
//                     <option>Medium</option>
//                     <option>Low</option>
//                   </select>
//                   <p className="text-xs text-[#717171] mt-1">
//                     Expected trade volume for this HS code
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                 </div>
//                 <div className="flex flex-col sm:flex-row sm:items-center gap-3">
//                   <div className="flex items-center gap-1.5 border border-[#448AFF] rounded-xl px-3 py-2 text-xs sm:text-base xl:text-lg text-[#448AFF] font-medium">
//                     <FaShield className="text-[#448AFF] text-xs sm:text-base" /> Risk : Low
//                   </div>
//                   <div>
//                     <p className="text-xs sm:text-sm ">AI Confidence Score</p>
//                     <p className="text-2xl font-bold text-[#448AFF]">92%</p>
//                     <div className="w-32 h-2 bg-gray-100 rounded-full mt-1">
//                       <div className="w-[92%] h-2 bg-[#448AFF] rounded-full" />
//                     </div>
//                   </div>
//                 </div>
//               </div>
//               <p className="text-sm sm:text-lg text-[#448AFF] font-medium mb-1">
//                 This HS Code has high export demand in UAE, Vietnam, and
//                 Germany.
//               </p>
//               <p className="text-xs sm:text-sm text-[#7C7C7C] mb-3">
//                 Consider focusing on quality certifications to increase market
//                 share
//               </p>
//               <div className="px-3 py-2 bg-[#E4EEFF] w-fit flex mb-3 justify-center   items-center rounded-lg"> <p className="text-xs font-semibold text-[#18599A] ">
//                 Suggested Related HS Codes
//               </p> </div>
...
//                   <div
//                     key={r.code + i}
//                     className="border border-gray-100 flex items-center rounded-xl px-2.5 gap-2 bg-gray-50 min-w-[120px]"
//                   >
//                     <p className="text-xs font-semibold text-gray-700">
//                       {r.code}
//                     </p>
//                     <p className="text-xs text-gray-400">{r.productName}</p>
//                     <p className="text-xs text-[#448AFF] font-medium  ">
//                       {r.match}
//                     </p>
//                   </div>
//                 ))}
//                 <div className="border  border-gray-100 rounded-xl p-2.5 gap-3 bg-gray-50 min-w-[120px] flex  items-center justify-center cursor-pointer hover:bg-teal-50 transition-colors">
//                   <div> <FaPlus className="text-[#448AFF] mb-1 text-lg" /></div>
//                    <div> <p className="text-xs text-[#448AFF] font-medium">View More</p>
//                   <p className="text-xs text-gray-400">12 more suggestion</p></div>
...
//                       <th className="text-left text-xs sm:text-sm lg:text-base font-normal  px-3 py-3 rounded-l-xl">
//                         Country
//                       </th>
//                       <th className="text-left text-xs sm:text-sm lg:text-base whitespace-nowrap font-normal  px-3 py-3">
//                         Import Status
//                       </th>
//                       <th className="text-left text-xs sm:text-sm lg:text-base whitespace-nowrap font-normal  px-3 py-3">
//                         Required Documents
...
//                         Last Updated
//                       </th>
//                       <th className="text-center text-xs sm:text-sm lg:text-base whitespace-nowrap font-normal  px-3 py-3 rounded-r-xl">
//                         Actions
//                       </th>
//                     </tr>
//                   </thead>
...
//                         <td className="text-sm flex gap-1 text-gray-700 px-3 py-3">
//                         <img src={c.img} />
//                           {c.country}
...
//                         <td className="px-3 py-3">
//                           <span
//                             className={`text-xs px-2.5 py-1 rounded-lg font-medium ${c.statusColor}`}
//                           >
//                             {c.status}
//                           </span>
//                         </td>
//                         <td className="text-xs text-gray-500 px-3 py-3 max-w-[160px]">
//                           {c.docs}
//                         </td>
//                         <td className="text-xs text-gray-500 px-3 py-3">
//                           {c.restriction}
//                         </td>
//                         <td className="text-xs text-gray-500 px-3 py-3 whitespace-nowrap">
//                           {c.updated}
//                         </td>
//                         <td className="text-center px-3 py-3">
//                           <button className="border border-gray-200 rounded-lg px-2 py-1 text-gray-500 hover:bg-gray-50 transition-colors">
...
//               <button
//                 onClick={onCancel}
//                 className="w-full sm:w-auto px-6 py-2.5 text-sm  border border-gray-200 rounded-xl hover:bg-gray-50 font-medium transition-colors"
//               >
//                 Cancel
//               </button>
//               <div className="flex gap-2 w-full sm:w-auto">
...
//                   className="flex-1 sm:flex-none px-6 py-2.5 text-sm text-[#0F8A7D] border border-[#0F8A7D] rounded-xl hover:bg-gray-50 font-medium transition-colors"
//                 >
//                   Save Draft
//                 </button>
//                 <button
//                   onClick={handleSubmit}
//                   className="flex-1 sm:flex-none flex items-center gap-2 bg-teal-500 hover:bg-teal-600 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition-colors"
//                 >
//                   <FaPaperPlane className="text-xs" /> Publish HS Code
//                 </button>
//               </div>
...
//           <div className="w-full xl:w-72 flex-shrink-0">
//             <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm xl:sticky xl:top-6">
//               <h2 className="text-sm sm:text-base xl:text-lg font-medium mb-1">
//                 HS Code Summary
//               </h2>
//               <p className="text-xs sm:text-sm font-medium mb-3">HS Code Preview</p>

//               <div className="bg-teal-500 rounded-xl px-4 py-3 mb-4 text-center">
//                 <p className="text-white font-bold text-lg tracking-wide">
//                   {form.hsCodeNumber || "090898790"}
//                 </p>
...
//                     {form.productCategories || "Agricultural Products"}
//                   </p>
//                 </div>
//                 <div>
//                   <p className="text-xs text-black">Industry</p>
//                   <p className="text-xs font-medium text-[#4C4C4C]">
//                     {form.industry || "Food & Beverages"}
//                   </p>
//                 </div>
//               </div>
...
//                     <span className="text-xs text-[#4C4C4C]">Import Duty</span>
//                     <span className="text-xs text-gray-700">
//                       {form.importDuty}%
//                     </span>
//                   </div>
//                   <div className="flex justify-between">
//                     <span className="text-xs text-[#4C4C4C]">Export Duty</span>
//                     <span className="text-xs text-gray-700">
//                       {form.exportDuty}%
//                     </span>
//                   </div>
//                   <div className="flex justify-between">
//                     <span className="text-xs text-[#4C4C4C]">Gst/Tax</span>
//                     <span className="text-xs text-gray-700">
//                       {form.gstTax}%
//                     </span>
//                   </div>
...
//                     Compliance Score
//                   </p>
//                   <span className="text-xs bg-[#D1FAF5] text-[#0F8A7D] px-2 py-0.5 rounded-lg font-medium">
//                     Complaint
//                   </span>
//                 </div>
...
//               <div className="border-t border-gray-100 pt-3 mb-4 flex flex-col gap-1">
//                 <div className="flex justify-between">
//                   <span className="text-xs text-gray-700">Last Updated</span>
