...
//     const yLabelsLeft = [0, 5000, 10000, 15000, 20000];
//     const yLabelsRight = [0, 20, 40, 60, 80];
  
//     return (
//       <div className="bg-white rounded-2xl border border-slate-100 shadow-md p-4 sm:p-5 px-5 w-full ">
//         <div>
//           <h1 className="text-lg md:text-2xl sm:px-2 py-2 font-medium">Trade Activity (This Month) </h1>
//         </div>
...
//     status: "Pending",
//   }]
// export default function TradeIntelligenceImport() {
...
//                Global import Intelligence
//               </h1>
//               <p className="text-xs sm:text-lg text-gray-600 mt-0.5">
//                 AI powered import shipment Analytics and trade intelligence
//               </p>
//             </div>
...
//                 >
//                 <div className={` ${s.color} w-8 h-8 hidden sm:flex items-center justify-center   rounded-md flex-shrink-0 `}>  
//                 <div className={`${s.color} w-8 h-8 hidden sm:flex items-center justify-center rounded-md flex-shrink-0`}>
//                     {s.icon && (
//                       typeof s.icon === "function" ? (
//                         <s.icon size={18} color={s.text} />
//                       ) : (
...
export default function ImportIntelligence() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] p-6 text-slate-700 antialiased font-sans pt-14">
