    ...
    <div className=" bg-gray-50 font-sans  flex-1 overflow-y-auto">
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 py-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-xl font-bold text-gray-900">HS Code Lookup</h1>
            <p className="text-xs text-gray-500 mt-0.5">Find the right HS code and get duty, tax, and trade insights.</p>
          </div>
      ...
      <div className="max-w-[1400px] mx-auto px-3 sm:px-4 lg:px-6 py-4 grid grid-cols-1 xl:grid-cols-[1fr_290px] gap-4">
        <div className="flex flex-col gap-4 min-w-0">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <p className="text-sm font-semibold text-gray-800 mb-2">Enter Product Description</p>
            <div className="flex gap-2">
              ...
              <button className="bg-teal-500 hover:bg-teal-600 text-white text-sm font-semibold px-5 py-2 rounded-lg flex items-center gap-1.5">
                <FiSearch size={14} /> Search
              </button>
            </div>

            <div className="mt-3">
              <p className="text-xs text-gray-500 font-medium mb-2">Additional Details (Optional)</p>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                <div>
                  <label className="text-[10px] text-gray-500 mb-1 block">Country of Export</label>
                  <div className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-700 cursor-pointer hover:border-gray-300 bg-white">
                    🇮🇳 India <FiChevronDown size={12} className="text-gray-400" />
                  </div>
                </div>
                <div>
                  <label className="text-[10px] text-gray-500 mb-1 block">Country of Import</label>
                  <div className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-700 cursor-pointer hover:border-gray-300 bg-white">
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    ...
                    <div className="flex items-center gap-1 border border-gray-200 rounded-lg px-2 py-2 text-xs text-gray-700 cursor-pointer bg-white">
                      KG <FiChevronDown size={11} className="text-gray-400" />
                    </div>
                  </div>
                </div>
                <div className="flex items-end">
                  <button className="w-full flex items-center justify-center gap-1.5 border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-600 hover:bg-gray-50">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <p className="text-sm font-semibold text-gray-800 mb-3">Best HS Code Match</p>
            <div className="border border-gray-200 rounded-xl p-4">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                <div>
                  <p className="text-[10px] text-gray-500 mb-1">HS Code</p>
                  <div className="flex items-center gap-1.5">
                    <span className="text-2xl font-bold text-gray-900">6109.10.00</span>
                  ...
                  <p className="text-[10px] text-gray-400 mt-1">T-shirts, singlets and other vests, of cotton</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500 mb-1">Match Score</p>
                  <p className="text-2xl font-bold text-gray-900">98%</p>
                  <ScoreBar score={98} />
                </div>
                <div>
                  <p className="text-[10px] text-gray-500 mb-1">HS Code Type</p>
                  <p className="text-base font-semibold text-gray-800">8 Digit</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500 mb-1">Classification Basis</p>
                  <p className="text-sm font-semibold text-gray-800">Chapter 61, Note 7, Section XI</p>
                </div>
                <div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <p className="text-sm font-semibold text-gray-800 mb-3">Other Possible Matches</p>
            <div className="overflow-x-auto">
              <table className="w-full min-w-[540px]">
                <thead>
                  <tr className="bg-gray-50">
                    {["HS Code", "Description", "Match Score", "HS Code Type", "Applicable Duty (UAE)", "Action"].map((h, i) => (
                      <th key={h} className={`text-left text-[11px] font-semibold text-gray-500 px-3 py-2.5 ${i === 0 ? "rounded-l-lg" : ""} ${i === 5 ? "rounded-r-lg" : ""}`}>
                        {h}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {otherMatches.map((row, i) => (
                    <tr key={i} className="border-t border-gray-100">
                      ...
                      <td className="px-3 py-3">
                        <button className="border border-gray-200 text-gray-700 text-[11px] font-medium px-3 py-1 rounded-lg hover:bg-gray-50">
                          View Details
                        </button>
                      </td>
                    </tr>
            ...
            <div className="flex overflow-x-auto border-b border-gray-200 mb-4 gap-0">
              {detailTabs.map((tab) => (
                <button
                  ...
                  className={`px-3 py-2 text-[11px] font-medium whitespace-nowrap border-b-2 -mb-px transition-colors
                    ${activeTab === tab ? "border-teal-500 text-teal-600" : "border-transparent text-gray-500 hover:text-gray-700"}`}
                >
                  {tab}
                </button>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-3">
                  <p className="flex items-center gap-1.5 text-[11px] font-semibold text-yellow-800 mb-1.5">
                    <FiAlertCircle size={13} className="text-yellow-500" /> AI Insight
                  </p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-3">
                  <p className="flex items-center gap-1.5 text-[11px] font-semibold text-blue-800 mb-2">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-3">
                  <p className="flex items-center gap-1.5 text-[11px] font-semibold text-orange-700 mb-1">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            ...
            <button className="text-teal-500 text-xs font-medium hover:underline flex items-center gap-1 mt-1">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            ...
            {[
              ...
              ["RCEP Benefit", "Not Applicable", "text-gray-500"],
              ["FTA Preference", "Not Applicable", "text-gray-500"],
            ...
            <button className="text-teal-500 text-xs font-medium hover:underline flex items-center gap-1 mt-2">
              View Trade Regulations <FiChevronRight size={12} />
            </button>
          </div>

          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <p className="text-sm font-semibold text-gray-800 mb-3">Document Requirements</p>
            {docReqs.map((doc) => (
