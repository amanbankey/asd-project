...
const plans = [
  {
    ...
    popular: false,
    icon: <FaPlane size={28} className="text-blue-400" />,
    iconBg: "bg-blue-50",
    features: [
  ...
  },
  {
    ...
    popular: true,
    icon: <FaBriefcase size={28} className="text-amber-600" />,
    iconBg: "bg-amber-50",
    features: [
      { label: "AI Queries", value: "50 / month" },
      { label: "Shipments", value: "50 / month" },
  ...
  },
  {
    ...
    popular: false,
    icon: <FaBuilding size={28} className="text-purple-400" />,
    iconBg: "bg-purple-50",
    features: [
      { label: "AI Queries", value: "50 / month" },
      { label: "Shipments", value: "50 / month" },
      ...
      <div className="max-w-[1400px] mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8">
          ...
          {plans.map((plan) => (
            <div key={plan.id} className={`relative bg-white rounded-2xl border shadow-sm flex flex-col ${plan.popular ? "border-teal-400 shadow-teal-100 shadow-md" : "border-gray-200"}`}>
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <button className="w-full border-2 border-teal-500 text-teal-600 text-sm font-bold rounded-xl py-2.5 hover:bg-teal-50 transition-colors mb-4">
                  {plan.btnLabel}
                </button>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm mb-6 overflow-hidden">
          <div className="p-5 sm:p-6 border-b border-gray-100">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Compare Plans</h2>
          </div>
              ...
              <tbody>
                {compareRows.map((row, i) => (
                  <tr key={i} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                    <td className="px-5 py-4 text-sm font-bold text-gray-900">{row.feature}</td>
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-2xl px-5 sm:px-8 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div>
            <h3 className="text-base sm:text-lg font-bold text-gray-900">30-Day Money Back Guarantee</h3>
            <p className="text-sm text-gray-500 mt-0.5">Not satisfied? Get a full refund within 30 days of your purchase.</p>
          </div>
